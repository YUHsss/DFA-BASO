...
model.load_state_dict(torch.load('./model/my_net/Net_epoch_45.pth'))
...
for dataset in test_datasets:
    save_path = './results/My/' + dataset + '/'
    rgb_savepath = r"E:\c_run\MyNet-main\results\My/RGB_EORSSD/"
    ...
    for i in range(test_loader.size):
        ...
        res = F.upsample(output[1], size=gt.shape, mode='bilinear', align_corners=False)
